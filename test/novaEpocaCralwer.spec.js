...
describe("Tests Nova Epoca Scrapper.", () => {
    ...
    it("Check Page Property Exists", async () => {
        
        const urlActive     = "https://www.novaepoca.com.br/prontos/apartamento-cascadura-2-quartos/25919";
        const urlInactive   = "https://www.novaepoca.com.br/prontos/apartamento-cascadura-2-quartos/28443";
        
        const NE = new NovaEpoca();
        const isActive1 = await NE.checkPropertyActive(urlActive);
        const isActive2 = await NE.checkPropertyActive(urlInactive);
